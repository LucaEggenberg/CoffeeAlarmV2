...
@dso_cache = dso_local local_unnamed_addr global [504 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.48_name, ; name: libaot-Xamarin.Google.Crypto.Tink.Android.dll.so
		ptr null; void* handle (0x0)
	}, ; 13
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 4002959611734029663, ; hash 0x378d5e8eeba4755f, from name: CoffeeAlarmV2
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CoffeeAlarmV2.dll.so
		ptr null; void* handle (0x0)
	}, ; 109
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 4471075680817272922, ; hash 0x3e0c73a49700585a, from name: aot-CoffeeAlarmV2.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CoffeeAlarmV2.dll.so
		ptr null; void* handle (0x0)
	}, ; 118
	...
	%struct.DSOCacheEntry {
		i64 4568326456724633913, ; hash 0x3f65f4b557173939, from name: CoffeeAlarmV2.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CoffeeAlarmV2.dll.so
		ptr null; void* handle (0x0)
	}, ; 123
	...
	%struct.DSOCacheEntry {
		i64 12878264940261602112, ; hash 0xb2b8c9bb2fa8f340, from name: libaot-CoffeeAlarmV2.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CoffeeAlarmV2.dll.so
		ptr null; void* handle (0x0)
	}, ; 347
	...
	%struct.DSOCacheEntry {
		i64 13456270298838095005, ; hash 0xbabe468adbe2549d, from name: aot-CoffeeAlarmV2
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CoffeeAlarmV2.dll.so
		ptr null; void* handle (0x0)
	}, ; 365
	...
	%struct.DSOCacheEntry {
		i64 15703660857817815213, ; hash 0xd9ee9c593f6fd8ad, from name: libaot-CoffeeAlarmV2
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CoffeeAlarmV2.dll.so
		ptr null; void* handle (0x0)
	}, ; 432
...
@.env.3 = private unnamed_addr constant [37 x i8] c"1b4e3b1e-58b0-4383-8483-8964112fa048\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [30 x i8] c"com.companyname.coffeealarmv2\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [28 x i8] c"libaot-CoffeeAlarmV2.dll.so\00", align 16
...
@.DSOCacheEntry.48_name = private unnamed_addr constant [49 x i8] c"libaot-Xamarin.Google.Crypto.Tink.Android.dll.so\00", align 16
